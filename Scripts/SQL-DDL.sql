...
CREATE SEQUENCE public.dim_pedido_sk_pedido_seq_1;

CREATE SEQUENCE public.dim_pedido_numerodopedido_seq;

CREATE TABLE public.Dim_Pedido (
                SK_pedido INTEGER NOT NULL DEFAULT nextval('public.dim_pedido_sk_pedido_seq_1'),
                NumeroDoPedido INTEGER NOT NULL DEFAULT nextval('public.dim_pedido_numerodopedido_seq'),
                SK_transportadora VARCHAR NOT NULL,
...
ALTER SEQUENCE public.dim_pedido_sk_pedido_seq_1 OWNED BY public.Dim_Pedido.SK_pedido;

ALTER SEQUENCE public.dim_pedido_numerodopedido_seq OWNED BY public.Dim_Pedido.NumeroDoPedido;

CREATE UNIQUE INDEX dim_pedido_idx
 ON public.Dim_Pedido
 ( NumeroDoPedido );
...
ALTER TABLE public.Dim_Pedido ADD CONSTRAINT dim_pedido_dim_tempo_fk
...
ALTER TABLE public.Dim_Pedido ADD CONSTRAINT dim_tempo_dim_pedido_fk
...
ALTER TABLE public.Dim_Pedido ADD CONSTRAINT dim_tempo_dim_pedido_fk1
...
ALTER TABLE public.Dim_Pedido ADD CONSTRAINT transportadoras_dim_pedido_fk
...
REFERENCES public.Dim_Pedido (SK_pedido)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
